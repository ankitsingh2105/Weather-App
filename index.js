...
moon.addEventListener('click', function (e) {
    if (check % 2 != 0) {
        ...
        sun[0].style.boxShadow = '1px 1px 3px white';
        sun[1].style.boxShadow = '1px 1px 3px white';
        sun[2].style.boxShadow = '1px 1px 3px white';
        sun[3].style.boxShadow = '1px 1px 3px white';
        sun[4].style.boxShadow = '1px 1px 3px white';
        sun[5].style.boxShadow = '1px 1px 3px white';
